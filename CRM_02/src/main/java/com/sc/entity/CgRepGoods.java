...
public class CgRepGoods implements Serializable {
    ...
    public CgRepGoods(Long cgRepId, Long cpId, Date jhDate, String zt, Long operaterId, String bzXx, Long companyId, Date lastTime) {
	...
	public String toString() {
		return "CgRepGoods [cgRepId=" + cgRepId + ", cpId=" + cpId + ", jhDate=" + jhDate + ", zt=" + zt
				...
				+ lastTime + ", cgOrderDetail=" + cgOrderDetail + ", kcGoodsInfo=" + kcGoodsInfo + "]";
	}
