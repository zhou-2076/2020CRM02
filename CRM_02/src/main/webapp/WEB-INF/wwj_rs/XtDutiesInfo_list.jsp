...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 职务管理 <span class="c-gray en">&gt;</span>  职务管理  <a class="btn btn-refresh radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
  <form action="cpdepotctrl/selectdepot.do" method="post" id="myform">
	<div class="text-c"> 日期范围：
		...
		<input type="text" value="${depot.depotName }" class="input-text" style="width:250px" placeholder="输入仓库名称" id="depotName" name="depotName">
	...
	<a href="javascript:;" onclick="member_add('添加仓库','cpdepotctrl/goadddepot.do','','350')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加仓库</a></span> 
	<span class="r">共有数据：<strong>${p.total }</strong> 条</span> </div>
	<div class="mt-20">
   <form action="cpdepotctrl/deletedepotall.do" method="post" id="myform1">
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
		   <c:forEach items="${p.list }" var="depot">
				<tr class="text-c">
					<td><input type="checkbox" value="${depot.depotId }" name="ids"></td>
					<td>${depot.depotId }</td>
					<td><u style="cursor:pointer" class="text-primary" onclick="member_show('张三','member-show.html','10001','360','400')">${depot.depotName }</u></td>
					<td class="text-l">${depot.remarkMessage }</td>
					<td>
					  <fmt:formatDate value="${depot.lastModifiedTime }" pattern="yyyy-MM-dd HH:mm:ss"/>
					</td>
					<td class="td-manage">
					<a title="商品信息" href="javascript:;" onclick="member_info('cpdepotctrl/gogoods.do?depotId=${depot.depotId }')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  
                    <a title="编辑" href="javascript:;" onclick="member_edit('编辑仓库','cpdepotctrl/goadddepot.do','${depot.depotId }','','350')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>  
					<a title="删除" href="javascript:;" onclick="member_del(this,'${depot.depotId }')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a></td>
				</tr>
			</c:forEach>
		</tbody>
