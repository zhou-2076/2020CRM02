...
<div class="page-container">
	...
	<a href="javascript:;" onclick="admin_permission_add('添加权限','xtperctrl/goaddper.do','','310')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		...
		<tbody>
			<tr class="text-c">
				<td><input type="checkbox" value="${XTPER.qxId }" name=""></td>
				<td>${XTPER.qxId }</td>
				<td>${XTPER.qxName }</td>
				<td>${XTPER.qx }</td>
				<td>${XTPER.qxFlId }</td>
				<td>${XTPER.bz }</td>
				<td>${XTPER.lastModifyDate }</td>
