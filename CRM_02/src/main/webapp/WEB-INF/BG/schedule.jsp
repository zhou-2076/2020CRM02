...
<!--
	...
	-->
<link href="<%=basePath%>js/schedule/jquery/jquery-ui.css" rel="stylesheet"
	type="text/css" />
<link href="<%=basePath%>js/schedule/css/mainstructure.css"
	rel="stylesheet" type="text/css" />
<link href="<%=basePath%>js/schedule/css/maincontent.css" rel="stylesheet"
	type="text/css" />
<link rel='stylesheet' type='text/css'
	href='<%=basePath%>js/schedule/cupertino/theme.css' />
<link rel='stylesheet' type='text/css'
	href='<%=basePath%>js/schedule/fullcalendar/fullcalendar.css' />
<link rel='stylesheet' type='text/css'
	href='<%=basePath%>js/schedule/fullcalendar/fullcalendar.print.css'
	media='print' />
<script src="<%=basePath%>js/schedule/jquery/jquery-1.8.2.min.js"
	type="text/javascript"></script>

<script src="<%=basePath%>js/schedule/jquery/jquery-ui.min1.9.1.js"
	type="text/javascript"></script>

<script
	src="<%=basePath%>js/schedule/jQuery-Timepicker-Addon-master/jquery-ui-timepicker-addon.js"></script>
<script
	src="<%=basePath%>js/schedule/jQuery-Timepicker-Addon-master/jquery-ui-sliderAccess.js"></script>
<script src="<%=basePath%>js/schedule/jquery/datepicker-zh.js"
	type="text/javascript"></script>
<link
	href="<%=basePath%>js/schedule/jQuery-Timepicker-Addon-master/jquery-ui-timepicker-addon.css"
	rel="stylesheet" />
<script src="<%=basePath%>js/schedule/fullcalendar/fullcalendar.js"
	type="text/javascript"></script>
	...
	<div id="wrap">
		...
		<div style="display: none" id="reservebox"
			...
			<form id="reserveformID" method="post">
				...
				<div class="rowElem">
					<label> 重要程度:</label> <select id="chengdu" name="confname">
