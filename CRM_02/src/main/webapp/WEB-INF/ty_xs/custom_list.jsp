...
<body>
	<nav class="breadcrumb">
		...
		用户中心 <span class="c-gray en">&gt;</span> 客户管理 <a
		...
		<div class="mt-20">
					...
					<c:forEach items="${p.list }" var="p">
						<tr class="text-c">
							...
							<td class="td-manage"><a style="text-decoration:none"
								onClick="cksjxq(${p.customId })" href="javascript:;" title="查看客户完整信息">
									<i class="Hui-iconfont">&#xe616;</i>
							</a> <a title="编辑" href="javascript:;" onclick="bj(${p.customId })"
								class="ml-5" style="text-decoration:none"> <i
									class="Hui-iconfont">&#xe6df;</i>
							</a> <a title="删除" href="javascript:;"
								onclick="return sc(${p.customId })" class="ml-5"
			...
			<div>
				...
				<div style="float: right;">
				  ...
				  location.href="purctrl/selectSup.do?pageNum="+${p.navigateFirstPage }+
				  ...
				  location.href="purctrl/selectSup.do?pageNum="+${p.prePage}+
				      "&name="+document.getElementById("ssz").value
				  }
				  </script>
					...
					<script type="text/javascript">
				     function xyy(){
				      ...
				      location.href="purctrl/selectSup.do?pageNum="+${p.nextPage}+
				      "&name="+document.getElementById("ssz").value
				    }
				   </script>
					<button onclick="wy()"
					...
					<script type="text/javascript">
				     function wy(){
				     location.href="purctrl/selectSup.do?pageNum="+${p.navigateLastPage }+
				      "&name="+document.getElementById("ssz").value
				    }
				  </script>
				</div>
